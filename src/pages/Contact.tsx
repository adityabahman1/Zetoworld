...
const banner = "/hero-banner-contact.png"
...
export function Contact() {
  return (
    <>
      <Head>
        <title>Contact Zeto | Get in Touch</title>
        <meta name="description" content="Have a question about Zeto's electric scooters, battery-swap stations, or franchise opportunities? Reach out to our team." />
        <link rel="canonical" href={`${SITE_URL}/contact`} />
        <meta property="og:title" content="Contact Zeto | Get in Touch" />
        <meta property="og:description" content="Reach the Zeto team for support, partnerships, or franchise inquiries." />
