    ...
    return (
      ...
      `}</style>
            ...
            <div className="mx-auto max-w-6xl text-center">
                <div className="mb-2 flex items-center justify-center gap-2 text-xs font-semibold uppercase tracking-[0.2em] text-[#3F7A4F]">
                    <span className="h-2 w-2 rounded-full bg-[#5FAE6A]" />
                    {eyebrow}
                </div>
                <h2 className="mx-auto max-w-2xl text-4xl font-black uppercase leading-[1.05] tracking-tight text-[#173A22] sm:text-5xl">
                    {headline}
                </h2>
                <p className="mx-auto mt-5 max-w-xl text-[17px] leading-relaxed text-[#4A5F4E]">{intro}</p>
            </div>
